...
- `EVD-OPS-001-01` — `SRC-0029` / paragraph 6
- `EVD-OPS-001-02` — `SRC-0027` / page 1
...
**Conclusion:** A single hosting provider carries an annual fee of EUR 288,000 and an aggregate creditor exposure of EUR 96,000, of which EUR 48,000 is aged beyond current. This supports payment-status diligence, but not an inference of default or threatened suspension.
...
- `EVD-OPS-002-01` — `SRC-0027` / page 1
- `EVD-OPS-002-02` — `SRC-0015` / Payables!E4
- `EVD-OPS-002-03` — `SRC-0015` / Payables!C4
- `EVD-OPS-002-04` — `SRC-0015` / Payables!D4
...
| client_linked_headcount | limitation | None |
| workforce_inconsistencies | analysed | LEGAL-004 |
